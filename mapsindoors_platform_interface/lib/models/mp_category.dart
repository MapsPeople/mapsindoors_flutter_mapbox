...
class MPCategory {
  ...
  static MPCategory? fromJson(json) => json != null && json != "null" ? MPCategory._fromJson(json is String ? jsonDecode(json) : json) : null;

  MPCategory._fromJson(data) {
    key = data["key"];
    value = data["value"];
    fields = (data["fields"] as Map<String, dynamic>?)?.map((key, value) => MapEntry(key, MPDataField.fromJson(value)!));
  }
}
