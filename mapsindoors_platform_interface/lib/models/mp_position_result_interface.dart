...
abstract class MPPositionResultInterface extends MapsIndoorsObject {
  ...
  Map<String, dynamic> toJson() {
    if (Platform.isIOS) {
      ...
      return {"coordinate": coordinate, "floorIndex": floorIndex, "bearing": bearing, "accuracy": accuracy, "providerName": provider.name};
    } else {
      return {"point": point, "floorIndex": floorIndex, "bearing": bearing, "accuracy": accuracy, "providerName": provider.name};
    }
  }
}
