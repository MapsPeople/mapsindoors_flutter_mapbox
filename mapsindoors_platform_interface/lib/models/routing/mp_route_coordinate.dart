...
class MPRouteCoordinate extends MapsIndoorsObject {
  ...
  Map<String, dynamic> toJson() {
    return {"lat": latitude, "lng": longitude, "zLevel": floorIndex, "floor_name": floorname};
  }

  /// Attempts to build a [MPRouteCoordinate] from a JSON object, this method will decode the object if needed
  static MPRouteCoordinate? fromJson(json) => json != null && json != "null" ? MPRouteCoordinate._fromJson(json is String ? jsonDecode(json) : json) : null;
