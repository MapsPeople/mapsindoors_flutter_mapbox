...
class MPSolutionConfig {
  ...
  static MPSolutionConfig? fromJson(json) => json != null && json != "null" ? MPSolutionConfig._fromJson(json is String ? jsonDecode(json) : json) : null;
  ...
  MPSolutionConfig._fromJson(data)
    ...
    if (data["collisionHandling"] is int) {
      _collisionHandling = MPCollisionHandling.fromValue(data["collisionHandling"]);
    } else {
      _collisionHandling = MPCollisionHandling.fromValue(int.parse(data["collisionHandling"]));
    }
  }
