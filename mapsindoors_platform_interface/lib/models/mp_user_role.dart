...
class MPUserRole extends MapsIndoorsObject {
  ...
  static MPUserRole? fromJson(json) => json != null && json != "null" ? MPUserRole._fromJson(json is String ? jsonDecode(json) : json) : null;
  ...
  @override
  bool operator ==(Object other) => other is MPUserRole && other.runtimeType == runtimeType && name.toLowerCase() == other.name.toLowerCase();
