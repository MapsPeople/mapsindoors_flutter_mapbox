...
class MPPoint extends MPGeometry {
  ...
  static MPPoint? fromJson(json) => json != null && json != "null" ? MPPoint._fromJson(json is String ? jsonDecode(json) : json) : null;
  ...
  set latitude(num lat) {
    _lat = lat.abs() > 90.0 ? (90.0 * lat.sign) : lat;
  }

  /// Set a new [longitude]
  set longitude(num lng) {
    _lng = lng.abs() > 180.0 ? (180.0 * lng.sign) : lng;
  }
