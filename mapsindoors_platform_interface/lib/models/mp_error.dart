...
class MPError {
  ...
  static MPError? fromJson(json) => json != null && json != "null" ? MPError._fromJson(json is String ? jsonDecode(json) : json) : null;
  ...
  @override
  bool operator ==(Object other) => (other is MPError && other.runtimeType == runtimeType && other.code == code);
