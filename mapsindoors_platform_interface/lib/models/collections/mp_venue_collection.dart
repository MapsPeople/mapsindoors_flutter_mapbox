...
class MPVenueCollection extends MPCollection<MPVenue> {
  ...
  static MPVenueCollection? fromJson(json) => json != null && json != "null" ? MPVenueCollection._fromJson(json is String ? jsonDecode(json) : json) : null;

  MPVenueCollection._fromJson(data) : super._() {
    _adminIdMap = new Map();
    List<MPVenue> venues = convertMIList<MPVenue>(data, (p0) => MPVenue.fromJson(p0));
