...
class MPUserRoleCollection extends MPCollection<MPUserRole> {
  ...
  static MPUserRoleCollection? fromJson(json) => json != null && json != "null" ? MPUserRoleCollection._fromJson(json is String ? jsonDecode(json) : json) : null;

  MPUserRoleCollection._fromJson(data) : super._() {
    List<MPUserRole> userroles = convertMIList<MPUserRole>(data, (p0) => MPUserRole.fromJson(p0));
