...
class MPBuildingInfo extends MapsIndoorsObject {
  ...
  static MPBuildingInfo? fromJson(json) => json != null && json != "null" ? MPBuildingInfo._fromJson(json is String ? jsonDecode(json) : json) : null;

  MPBuildingInfo._fromJson(data) {
    _name = data["name"];
    _aliases = data["aliases"] != null ? convertJsonArray<String>(data["aliases"]) : null;
    _fields = data["fields"] != null ? (data?["fields"] as Map<String, dynamic>).map((key, value) => MapEntry(key, MPDataField.fromJson(value)!)) : null;
  }

  /// Converts the [MPBuilding] to a JSON representation that can be parsed by the MapsIndoors Platform SDK
  @override
  Map<String, dynamic> toJson() => {"name": _name, "aliases": _aliases, "fields": _fields};
