...
class MPDisplayRule implements DynamicObject<MPDisplayRuleId> {
  ...
  Future<bool?> isIconVisible() => DisplayRulePlatform.instance.isIconVisible(id);

  /// Set the icon's visibility value
  Future<void> setIconVisible(bool visible) => DisplayRulePlatform.instance.setIconVisible(id, visible);
  ...
  /// Set the icon's URL
  Future<void> setIcon(String url) => DisplayRulePlatform.instance.setIcon(id, url);

  /// Get the icon's size
  Future<MPIconSize?> getIconSize() => DisplayRulePlatform.instance.getIconSize(id);

  /// Set the icon's size
  Future<void> setIconSize(MPIconSize size) => DisplayRulePlatform.instance.setIconSize(id, size);

  /// Get the label's visibility value
  Future<bool?> isLabelVisible() => DisplayRulePlatform.instance.isLabelVisible(id);
  ...
  Future<num?> getLabelZoomFrom() => DisplayRulePlatform.instance.getLabelZoomFrom(id);
  ...
  Future<num?> getLabelZoomTo() => DisplayRulePlatform.instance.getLabelZoomTo(id);
  ...
  Future<int?> getLabelMaxWidth() => DisplayRulePlatform.instance.getLabelMaxWidth(id);
  ...
  Future<bool?> isPolygonVisible() => DisplayRulePlatform.instance.isPolygonVisible(id);

  /// Set the polygon's visibility value
  Future<void> setPolygonVisible(bool visible) => DisplayRulePlatform.instance.setPolygonVisible(id, visible);

  /// Get the polygon's zoom from value
  Future<num?> getPolygonZoomFrom() => DisplayRulePlatform.instance.getPolygonZoomFrom(id);
  ...
  Future<num?> getPolygonZoomTo() => DisplayRulePlatform.instance.getPolygonZoomTo(id);

  /// Set the polygon's zoom to value
  Future<void> setPolygonZoomTo(num to) => DisplayRulePlatform.instance.setPolygonZoomTo(id, to);

  /// Get the polygon's stroke width value
  Future<num?> getPolygonStrokeWidth() => DisplayRulePlatform.instance.getPolygonStrokeWidth(id);
  ...
  Future<String?> getPolygonStrokeColor() => DisplayRulePlatform.instance.getPolygonStrokeColor(id);

  /// Set the polygon's stroke color value
  Future<void> setPolygonStrokeColor(String color) => DisplayRulePlatform.instance.setPolygonStrokeColor(id, color);

  /// Get the polygon's stroke opacity value
  Future<num?> getPolygonStrokeOpacity() => DisplayRulePlatform.instance.getPolygonStrokeOpacity(id);

  /// Set the polygon's stroke opacity value
  Future<void> setPolygonStrokeOpacity(num opacity) => DisplayRulePlatform.instance.setPolygonStrokeOpacity(id, opacity);

  /// Get the polygon's fill color value
  Future<String?> getPolygonFillColor() => DisplayRulePlatform.instance.getPolygonFillColor(id);
  ...
  Future<num?> getPolygonFillOpacity() => DisplayRulePlatform.instance.getPolygonFillOpacity(id);

  /// Set the polygon's fill opacity value
  Future<void> setPolygonFillOpacity(num opacity) => DisplayRulePlatform.instance.setPolygonFillOpacity(id, opacity);

  // wall
  /// Get the wall's visibility value
  Future<bool?> isWallVisible() => DisplayRulePlatform.instance.isWallVisible(id);
  ...
  Future<String?> getWallColor() => DisplayRulePlatform.instance.getWallColor(id);
  ...
  Future<num?> getWallHeight() => DisplayRulePlatform.instance.getWallHeight(id);
  ...
  Future<num?> getWallZoomFrom() => DisplayRulePlatform.instance.getWallZoomFrom(id);
  ...
  Future<num?> getWallZoomTo() => DisplayRulePlatform.instance.getWallZoomTo(id);
  ...
  Future<bool?> isExtrusionVisible() => DisplayRulePlatform.instance.isExtrusionVisible(id);

  /// Set the extrusion's visibility value
  Future<void> setExtrusionVisible(bool visible) => DisplayRulePlatform.instance.setExtrusionVisible(id, visible);

  /// Get the extrusion's color value
  Future<String?> getExtrusionColor() => DisplayRulePlatform.instance.getExtrusionColor(id);
  ...
  Future<num?> getExtrusionHeight() => DisplayRulePlatform.instance.getExtrusionHeight(id);
  ...
  Future<num?> getExtrusionZoomFrom() => DisplayRulePlatform.instance.getExtrusionZoomFrom(id);
  ...
  Future<num?> getExtrusionZoomTo() => DisplayRulePlatform.instance.getExtrusionZoomTo(id);

  /// Set the extrusion's zoom to value
  Future<void> setExtrusionZoomTo(num to) => DisplayRulePlatform.instance.setExtrusionZoomTo(id, to);

  //2d models
  /// Get the 2D model's visibility value
  Future<bool?> isModel2DVisible() => DisplayRulePlatform.instance.isModel2DVisible(id);

  /// Set the 2D model's visibility value
  Future<void> setModel2DVisible(bool visible) => DisplayRulePlatform.instance.setModel2DVisible(id, visible);

  /// Get the 2D model's zoom from value
  Future<num?> getModel2DZoomFrom() => DisplayRulePlatform.instance.getModel2DZoomFrom(id);
  ...
  Future<num?> getModel2DZoomTo() => DisplayRulePlatform.instance.getModel2DZoomTo(id);
  ...
  Future<String?> getModel2DModel() => DisplayRulePlatform.instance.getModel2DModel(id);
  ...
  Future<num?> getModel2DWidthMeters() => DisplayRulePlatform.instance.getModel2DWidthMeters(id);
  ...
  Future<num?> getModel2DHeightMeters() => DisplayRulePlatform.instance.getModel2DHeightMeters(id);

  /// Set the 2D model's height in meters
  Future<void> setModel2DHeightMeters(num height) => DisplayRulePlatform.instance.setModel2DHeightMeters(id, height);

  /// Get the 2D model's bearing value
  Future<num?> getModel2DBearing() => DisplayRulePlatform.instance.getModel2DBearing(id);
