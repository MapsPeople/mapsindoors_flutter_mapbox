...
class MethodChannelMapControl extends MapcontrolPlatform {
  ...
  @visibleForTesting
  final mapControlMethodChannel = const MethodChannel('MapControlMethodChannel');
  final listenerChannel = const MethodChannel('MapControlListenerMethodChannel');
  final floorSelectorChannel = const MethodChannel('MapControlFloorSelectorChannel');
  final List<MPCameraEventListener> _cameraEventListeners = List.empty(growable: true);
  final List<OnFloorUpdateListener> _floorUpdateListeners = List.empty(growable: true);
  ...
  MethodChannelMapControl() {
    ...
    floorSelectorChannel.setMethodCallHandler((call) => _floorSelectorHandler(call));
    mapControlMethodChannel.setMethodCallHandler((call) => _mapControlHandler(call));
  }
    ...
    switch (call.method) {
      ...
      case "onMapClick":
        ...
        if (call.arguments["locations"] != null) {
          final locations = (jsonDecode(call.arguments["locations"]) as List<dynamic>).map((e) => MPLocation.fromJson(e)!);
      ...
      case "onLiveLocationUpdate":
        ...
        if (location != null) {
          _liveUpdateListeners[call.arguments["type"] as String]?.call(location);
        }
        break;
      default:
        throw UnimplementedError();
  ...
  Future<dynamic> _floorSelectorHandler(MethodCall call) async {
    switch (call.method) {
      case "setList":
        final floors = convertMIList<MPFloor>(jsonDecode(call.arguments), (p0) => MPFloor.fromJson(p0));
      ...
      case "setSelectedFloor":
        _floorSelector?.setSelectedFloor(MPFloor.fromJson(jsonDecode(call.arguments))!);
        break;
  ...
  @override
  Future<void> setFloorSelector(MPFloorSelectorInterface? floorSelector, bool internal) {
    _floorSelector = floorSelector;
    _floorSelector?.onFloorSelectionChangedListener = onFloorSelectionChanged;
    if (internal) {
      return Future(() => null);
    } else {
      return mapControlMethodChannel.invokeMethod("MPC_setFloorSelector", {"isAutoFloorChangeEnabled": floorSelector?.isAutoFloorChangeEnabled});
    }
  }
  ...
  void onFloorSelectionChanged(MPFloor newFloor) {
    floorSelectorChannel.invokeMethod("FSE_onFloorChanged", {"floor": newFloor._jsonEncode()});
  }

  @override
  Future<void> selectFloor(int floorIndex) {
    return mapControlMethodChannel.invokeMethod("MPC_selectFloor", {"floorIndex": floorIndex});
  }
  ...
  Future<MPBuilding?> getCurrentBuilding() async {
    final buildingData = await mapControlMethodChannel.invokeMethod("MPC_getCurrentBuilding");
    return MPBuilding.fromJson(buildingData);
  }

  @override
  Future<MPFloor?> getCurrentBuildingFloor() async {
    final floorData = await mapControlMethodChannel.invokeMethod("MPC_getCurrentBuildingFloor");
  ...
  Future<num?> getCurrentMapsIndoorsZoom() {
    return mapControlMethodChannel.invokeMethod("MPC_getCurrentMapsIndoorsZoom");
  }

  @override
  Future<MPVenue?> getCurrentVenue() async {
    final venueData = await mapControlMethodChannel.invokeMethod("MPC_getCurrentVenue");
    return MPVenue.fromJson(venueData);
  }

  @override
  Future<MPMapStyle?> getMapStyle() async {
    final mapStyleData = await mapControlMethodChannel.invokeMethod("MPC_getMapStyle");
  ...
  Future<void> goTo(MPEntity? entity) {
    return mapControlMethodChannel.invokeMethod("MPC_goTo", {"entity": entity?._jsonEncode(), "type": entity?.runtimeType.toString()});
  }

  @override
  Future<void> hideFloorSelector(bool hide) {
    return mapControlMethodChannel.invokeMethod("MPC_hideFloorSelector", {"hide": hide});
  }
  ...
  Future<void> selectBuilding(MPBuilding building, bool moveCamera) {
    return mapControlMethodChannel.invokeMethod("MPC_selectBuilding", {"building": building._jsonEncode(), "moveCamera": moveCamera});
  }

  @override
  Future<void> selectLocation(MPLocation? location, MPSelectionBehavior behavior) {
    return mapControlMethodChannel.invokeMethod("MPC_selectLocation", {"location": location?.id.value, "behavior": behavior._jsonEncode()});
  }

  @override
  Future<void> selectLocationById(String id, MPSelectionBehavior behavior) {
    return mapControlMethodChannel.invokeMethod("MPC_selectLocationById", {"id": id, "behavior": behavior._jsonEncode()});
  }

  @override
  Future<void> selectVenue(MPVenue venue, bool moveCamera) {
    return mapControlMethodChannel.invokeMethod("MPC_selectVenue", {"venue": venue._jsonEncode(), "moveCamera": moveCamera});
  }

  @override
  Future<bool> setFilter(MPFilter filter, MPFilterBehavior behavior) async {
    final res = await mapControlMethodChannel.invokeMethod("MPC_setFilter", {"filter": filter._jsonEncode(), "behavior": behavior._jsonEncode()});
    return (res == "success");
  }

  @override
  Future<void> setFilterWithLocations(List<MPLocation?> locations, MPFilterBehavior behavior) {
    return mapControlMethodChannel.invokeMethod("MPC_setFilterWithLocations", {"locations": locations.map((e) => e?.id.value).toList(), "behavior": behavior._jsonEncode()});
  }

  @override
  Future<void> setMapPadding(int start, int top, int end, int bottom) {
    return mapControlMethodChannel.invokeMethod("MPC_setMapPadding", {"start": start, "top": top, "end": end, "bottom": bottom});
  }

  @override
  Future<void> setMapStyle(MPMapStyle mapstyle) {
    return mapControlMethodChannel.invokeMethod("MPC_setMapStyle", {"mapStyle": mapstyle._jsonEncode()});
  }

  @override
  Future<void> showInfoWindowOnClickedLocation(bool show) {
    return mapControlMethodChannel.invokeMethod("MPC_showInfoWindowOnClickedLocation", {"show": show});
  }

  @override
  Future<void> showUserPosition(bool show) {
    return mapControlMethodChannel.invokeMethod("MPC_showUserPosition", {"show": show});
  }

  @override
  Future<void> disableLiveData(String domainType) {
    return mapControlMethodChannel.invokeMethod("MPC_disableLiveData", {"domainType": domainType});
  }

  @override
  Future<void> enableLiveData(String domainType, OnLiveLocationUpdateListener? listener) {
    if (listener != null) {
      _liveUpdateListeners.putIfAbsent(domainType, () => listener);
    }
    return mapControlMethodChannel.invokeMethod("MPC_enableLiveData", {"domainType": domainType, "listener": (listener != null)});
  }

  @override
  void addOnCameraEventListner(MPCameraEventListener listener) {
    if (_cameraEventListeners.isEmpty) {
      listenerChannel.invokeMethod("MPL_cameraEventListener", {"setupListener": true});
    }
  ...
  void addOnFloorUpdateListener(OnFloorUpdateListener listener) {
    if (_floorUpdateListeners.isEmpty) {
      listenerChannel.invokeMethod("MPL_floorUpdateListener", {"setupListener": true});
    }
  ...
  void setOnCurrentBuildingChangedListener(OnBuildingFoundAtCameraTargetListener? listener) {
    listenerChannel.invokeMethod("MPL_buildingFoundAtCameraTargetListener", {"setupListener": listener != null});
  ...
  void setOnCurrentVenueChangedListener(OnVenueFoundAtCameraTargetListener? listener) {
    listenerChannel.invokeMethod("MPL_venueFoundAtCameraTargetListener", {"setupListener": listener != null});
  ...
  void removeOnCameraEventListner(MPCameraEventListener listener) {
    ...
    if (_cameraEventListeners.isEmpty) {
      listenerChannel.invokeMethod("MPL_cameraEventListener", {"setupListener": false});
    }
  }
  ...
  void removeOnFloorUpdateListener(OnFloorUpdateListener listener) {
    ...
    if (_floorUpdateListeners.isEmpty) {
      listenerChannel.invokeMethod("MPL_floorUpdateListener", {"setupListener": false});
    }
  }

  @override
  void setOnLocationSelectedListener(OnLocationSelectedListener? listener, bool? consumeEvent) {
    listenerChannel.invokeMethod("MPL_locationSelectedListener", {"setupListener": listener != null, "consumeEvent": consumeEvent});
    _locationSelectedListener = listener;
  }

  @override
  void setOnMapClickListener(OnMapClickListener? listener, bool? consumeEvent) {
    listenerChannel.invokeMethod("MPL_mapClickListener", {"setupListener": listener != null, "consumeEvent": consumeEvent});
    _mapClickListener = listener;
  }

  @override
  void setOnMarkerClickListener(OnMarkerClickListener? listener, bool? consumeEvent) {
    listenerChannel.invokeMethod("MPL_markerClickListener", {"setupListener": listener != null, "consumeEvent": consumeEvent});
    _markerClickListener = listener;
  }

  @override
  void setOnMarkerInfoWindowClickListener(OnMarkerInfoWindowClickListener? listener) {
    listenerChannel.invokeMethod("MPL_markerInfoWindowClickListener", {"setupListener": listener != null});
    _infoWindowClickListener = listener;
  }

  @override
  Future<void> animateCamera(MPCameraUpdate update, [int? duration]) {
    return mapControlMethodChannel.invokeMethod("MPC_animateCamera", {"update": update._jsonEncode(), "duration": duration});
  }

  @override
  Future<MPCameraPosition> currentCameraPosition() async {
    final res = await mapControlMethodChannel.invokeMethod("MPC_getCurrentCameraPosition");
    return MPCameraPosition._fromJson(jsonDecode(res));
  }

  @override
  Future<void> moveCamera(MPCameraUpdate update) {
    return mapControlMethodChannel.invokeMethod("MPC_moveCamera", {"update": update._jsonEncode()});
  }
