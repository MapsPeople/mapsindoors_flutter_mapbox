...
class MPDirectionsService {
  ...
  Future<void> addAvoidWayType(String avoidWayType) => DirectionsServicePlatform.instance.addAvoidWayType(avoidWayType);

  /// Clears all added avoidWayTypes
  Future<void> clearWayType() => DirectionsServicePlatform.instance.clearWayType();

  /// Sets whether routes should use departure time or arrival time when using the transit travel mode
  Future<void> setIsDeparture(bool isDeparture) => DirectionsServicePlatform.instance.setIsDeparture(isDeparture);
  ...
  Future<MPRoute> getRoute({required MPPoint origin, required MPPoint destination}) => DirectionsServicePlatform.instance.getRoute(origin, destination);
  ...
  ///
  /// transit
  Future<void> setTravelMode(String travelMode) => DirectionsServicePlatform.instance.setTravelMode(travelMode);
  ...
  Future<void> setTime(int time) => DirectionsServicePlatform.instance.setTime(time);
}
