...
class MapsIndoorsWidget extends UniqueWidget {
  ...
  Future<void> selectBuilding(FutureOr<MPBuilding> building, bool moveCamera) async {
  ...
  Future<void> selectLocation(FutureOr<MPLocation?> location, [MPSelectionBehavior? behavior]) async {
