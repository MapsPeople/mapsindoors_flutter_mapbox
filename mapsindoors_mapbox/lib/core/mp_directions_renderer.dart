...
class MPDirectionsRenderer {
  ...
  Future<void> setRoute(MPRoute? route) => DirectionsRendererPlatform.instance.setRoute(route);
  ...
  Future<void> previousLeg() => DirectionsRendererPlatform.instance.previousLeg();

  /// Enable/Disable the polyline animation when displaying a route element on the map
  Future<void> setAnimatedPolyline(bool animated, bool repeating, int durationMs) => DirectionsRendererPlatform.instance.setAnimatedPolyline(animated, repeating, durationMs);
  ...
  Future<void> selectLegIndex(int legIndex) => DirectionsRendererPlatform.instance.selectLegIndex(legIndex);
  ...
  Future<void> setCameraAnimationDuration(int durationMs) => DirectionsRendererPlatform.instance.setCameraAnimationDuration(durationMs);
  ...
  Future<void> setCameraViewFitMode(MPCameraViewFitMode mpCameraViewFitMode) => DirectionsRendererPlatform.instance.setCameraViewFitMode(mpCameraViewFitMode);
  ...
  Future<void> setOnLegSelectedListener(OnLegSelectedListener? onLegSelectedListener) => DirectionsRendererPlatform.instance.setOnLegSelectedListener(onLegSelectedListener);
}
